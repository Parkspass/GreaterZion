...
const staticCacheName = 'site-static-v6'; // Need to change version number ANYTIME we change HTML or CSS files. This is how we get the app to update. The browser needs to detect a change in the service worker.
const assets = [
